			...
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend">
						<span class="add-on">
							<span class="icon-user hasTooltip" title="<?php echo JText::_('Email') ?>"></span>
							<label for="modlgn-email" class="element-invisible"><?php echo JText::_('Email'); ?></label>
						</span>
						<input id="modlgn-email" type="text" name="email" class="input-small" tabindex="0" size="18" placeholder="<?php echo JText::_('Email') ?>" />
					</div>
				<?php else: ?>
